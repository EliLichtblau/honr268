...
TString bg1 = "./output_GluGluToHToZZTo4L_M-125_7TeV-powheg15-pythia6.root"
;

TString bg2 = "./output_SMHiggsToZZTo4L_M-122_7TeV-powheg15-JHUgenV3-pythia6.root"
;
TString bg3 = "./output_SMHiggsToZZTo4L_M-126_7TeV-powheg15-JHUgenV3-pythia6.root"
;
...
TFile *input1 = TFile::Open( bg3);
//TFile *input2 = TFile::Open( fname2 );

TFile *bgIn1 = TFile::Open( bg1 );
TFile *bgIn2 = TFile::Open( bg2 );
TFile *bgIn3 = TFile::Open( fname1 );
...
TTree *background1 = (TTree*)bgIn1->Get("HZZ4LeptonsAnalysisReduced");

TTree *background2 = (TTree*)bgIn2->Get("HZZ4LeptonsAnalysisReduced");
TTree *background3 = (TTree*)bgIn3->Get("HZZ4LeptonsAnalysisReduced");



// global event weights per tree (see below for setting event-wise weights)
Double_t signalWeight = 1.0;
Double_t backgroundWeight = 1./3;
