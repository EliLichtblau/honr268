...
void HiggsAnalysis::Loop()
{
	...
	/*
	tree->Branch("el2_pt", &el2_pt, "el2_pt");
	tree->Branch("el3_pt", &el3_pt, "el3_pt/F");
	tree->Branch("el4_pt", &el4_pt, "el4_pt/F");

	tree->Branch("el1_eta", &el1_eta, "el1_eta/F");
	tree->Branch("el2_eta", &el2_eta, "el2_eta/F");
	*/
	double el1mt = 0.0;
	double el1pt = 0.0;
	double el1eta = 0.0;
	for (Long64_t jentry=0; jentry<nentries;jentry++) {
		...
		H_zz->Fill(zCandidate2.M());
		 ZH_sum->Fill(higgsCandidate.M());

		el1_pt->Fill(el1.Pt());
		el1_eta->Fill(el1.Eta());
		el1_phi->Fill(el1.Phi());
		el2_pt->Fill(el2.Pt());
		el2_eta->Fill(el2.Eta());
		el2_phi->Fill(el2.Phi());
		el3_pt->Fill(el3.Pt());
		el3_eta->Fill(el3.Eta());
		el3_phi->Fill(el3.Phi());
		el4_pt->Fill(el4.Pt());
		el4_eta->Fill(el4.Eta());
		el4_phi->Fill(el4.Phi());
		*/
